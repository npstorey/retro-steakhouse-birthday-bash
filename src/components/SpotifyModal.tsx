...
const SpotifyModal = ({ onClose }: SpotifyModalProps) => {
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full h-full p-0 bg-[#1a1a1a] border-8 border-[#333] sm:p-6 rounded-none sm:rounded-xl text-steakhouse-cream sm:max-w-3xl sm:h-auto sm:max-h-[90vh] overflow-y-auto shadow-[0_0_50px_rgba(219,39,119,0.3),inset_0_0_30px_rgba(0,0,0,0.5)] animate-fade-in before:content-[''] before:absolute before:inset-0 before:bg-[url('/lovable-uploads/98cb7c30-ae18-44ee-b1c0-52b56ab6693d.png')] before:opacity-10 before:pointer-events-none">
        <DialogHeader>
        ...
        <div className="relative space-y-6 px-2 sm:px-6 pt-8 pb-6">
          {/* Metallic strips */}
          ...
          <div className="space-y-4 relative">
            <div className="text-center mb-8 relative">
              ...
              <h2 className="relative font-display text-3xl sm:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-steakhouse-blue via-steakhouse-pink to-steakhouse-maroon animate-neon-pulse mb-4 drop-shadow-[0_0_10px_rgba(219,39,119,0.5)]">
            ...
            <div className="flex flex-wrap gap-4 justify-center my-8">
              <Button
                ...
                className="relative bg-steakhouse-maroon hover:bg-steakhouse-pink text-white font-bold px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(219,39,119,0.7)] transform hover:scale-105 border-2 border-steakhouse-maroon/30"
              >
              ...
              <Button
                ...
                className="relative bg-steakhouse-blue hover:bg-steakhouse-pink text-white font-bold px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(30,174,219,0.7)] transform hover:scale-105 border-2 border-steakhouse-blue/30"
              >
                <span className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent rounded-full"></span>
              ...
              <Button
                ...
                className="relative bg-steakhouse-pink hover:bg-steakhouse-blue text-white font-bold px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(139,92,246,0.7)] transform hover:scale-105 border-2 border-steakhouse-pink/30"
              >
                <span className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent rounded-full"></span>
            ...
            <div className="relative w-full mt-6 rounded-xl overflow-hidden border-4 border-[#333] shadow-[0_0_30px_rgba(219,39,119,0.3),inset_0_0_20px_rgba(0,0,0,0.5)]">
              <iframe 
                id="spotifyEmbed"
            ...
            <div className="bg-black/60 p-6 sm:p-8 rounded-xl backdrop-blur-sm border-2 border-steakhouse-maroon/30 shadow-inner mt-8">
              <p className="text-base sm:text-lg leading-relaxed mb-6 text-steakhouse-cream/90">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-steakhouse-cream/90">
